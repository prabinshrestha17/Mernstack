...
productRouter.post(
  ...
  isAuthorized(["seller"]), // req.userId bata id get huncha rw yo middleware chalcha aaba middleware ma user ko role check huncha isAuthorized function ma role bhanney parameter huncha jasko value yaha bata argument ma pathaincha is role user ko role sanga mileyna bhani error aaucha 403 forbidden ko
  createProductController
);
